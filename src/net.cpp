...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kakapocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kakapocointools.com", "dnsseed.kakapocointools.com"},
    {"kakapocoinpool.org", "dnsseed.kakapocoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"kakapocointools.com", "testnet-seed.kakapocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kakapocoin is probably already running."), addrBind.ToString().c_str());
        else
